...
public class DiseasedStab extends CustomCard
{
    public static final String ID = "Reborn:DiseasedStab";
    ...
    private static final int SHROUD = 8;
    ...
    public void use(AbstractPlayer p, AbstractMonster m)
    {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(new Infection(), 2, false, true, false));
    }

    @Override
    public AbstractCard makeCopy()
    {
        return new DiseasedStab();
    }
